...
int main()
{
	...
	pOut->PrintMessage("Drawing a highlighted line, Click two points");
	pIn->GetPointClicked(P1.x, P1.y);
	pIn->GetPointClicked(P2.x, P2.y);
	...
	gfxInfo.DrawClr = BLACK;	//any color for border
	gfxInfo.isFilled = false;	//Figure is NOT filled
	pOut->DrawPolly(P1, gfxInfo, false);
	...
	pIn->GetPointClicked(x, y);	//Wait for any click
	pOut->DrawPolly(P1, gfxInfo, true);


	// 2.1.3 - Drawing a filled rhombus
	pOut->PrintMessage("Drawing a Rhombus ==> filled,  Click two point");
	pIn->GetPointClicked(P1.x, P1.y);
	...
	pOut->PrintMessage("Drawing an Ellipse ==> filled,  Click a point");
	pIn->GetPointClicked(P1.x, P1.y);
	...
	// 3.5.4 Drawing a highlighted filled ellipse
	...
	pOut->PrintMessage("Enter anything");
